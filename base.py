...
with h.File(hdf,"a") as f:
    ...
    #eddynet.fit(train_nrcs,train_mask,shuffle='batch',verbose=1,batch_size=batch_size,epochs=epochs,validation_data=(test_nrcs,test_mask))
