...
with h.File(hdf,"a") as f:
    ...
    if not f.__contains__("weights/"+fl):
        ...
        f.require_dataset("masks/testing_images/"+fl,(nb_set2,size_out*size_out,nbClass),maxshape=(None,size_out*size_out,nbClass),dtype='f4')
        ...
        a%=4
        a=a.reshape(-1,b)
        f.require_dataset("masks/training_images/"+fl,(nb_set1,size_out*size_out,nbClass),maxshape=(None,size_out*size_out,nbClass),dtype='f4')
